    ...
    const ImageComponent = () => {
        return (
            <div className='relative  w-[198px] mx-2'>
                ...
                <div className='flex text-[14px] gap-[2px] items-center justify-center border border-gray-400 rounded-full w-[140px] h-[30px] mt-2'>
                ...
                <div className="flex flex-row gap-2 items-emd mt-2">
                    ...
                    <div className='font-[500] text-[12px] line-through text-gray-400 mt-2'>&#x24; 7.49</div>
