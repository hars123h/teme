                    ...
                    <div className="px-[148px] mt-[150px] py-2">
                        <Breadcrumb
                            ...
                            items={[
                                ...
                                {
                                    title: <a href="">About Temu</a>,
                                }
                            ]}
                        />
                    </div>

                    <div className="mx-[200px] h-[42px] text-center text-[#fb7701]">
                        <div className='text-[28px] leading-[42px] underline font-[500]'>What is Temu?</div>
                    </div>

                    <div className="mx-[190px] gap-[23px] flex flex-row items-center text-[#fb7701] mt-[10px]">
                        <Image src={about1} className='w-[182px] h-[141px]' />
                        <div className='text-[14px] leading-[27px] text-[#555555]'>
                            <span className="underline">Temu</span>
                            <i> (tee - moo)</i> is an
                            online marketplace that connects consumers with millions of sellers,
                            manufacturers and brands around the world with the mission to empower
                            them to live their best lives. Temu is committed to offering the most
                            affordable quality products to enable consumers and sellers to fulfill
                            their dreams in an inclusive environment. Temu was founded in Boston,
                            Massachusetts in 2022.
                        </div>
                    </div>

                    <div className="mx-[200px] h-[42px] mt-[36px] text-center text-[#fb7701]">
                        <div className='text-[28px] leading-[42px] font-[500]'>What does Temu mean?</div>
                    </div>

                    <div className="mx-[190px] gap-[5px] flex flex-col  text-[#fb7701] mt-[10px]">
                        <div className='text-[14px] leading-[27px] text-[#555555]'>
                            Temu means – TEAM UP, PRICE DOWN
                        </div>

                        <div className='text-[14px] leading-[27px] text-[#555555]'>
                            We hope that you will enjoy the affordable, quality products
                            we offer on our marketplace from millions of sellers, manufacturers
                            and brands around the world.
                        </div>
                    </div>

                    <div className="mx-[200px] h-[42px] mt-[36px] text-center text-[#fb7701]">
                        <div className='text-[28px] leading-[42px] font-[500]'>How do you pronounce Temu?</div>
                    </div>

                    <div className="mx-[190px] gap-[5px] flex flex-col  text-[#fb7701] mt-[10px]">
                        <div className='text-[14px] leading-[27px] text-[#555555]'>
                            It is as simple as tee-moo!
                        </div>

                        <div className='text-[14px] leading-[27px] text-[#555555]'>
                            Our vision is that in this inclusive environment of Temu communities,
                            you are empowered to live the best life you dream of having.
                        </div>
                    </div>

                    <div className="mx-[200px] h-[42px] mt-[36px] text-center text-[#fb7701]">
                        <div className='text-[28px] leading-[42px] underline font-[500]'>Where does Temu ship from?</div>
                    </div>

                    <div className="mx-[190px] gap-[23px]   text-[#fb7701] mt-[10px]">
                        <span className='text-[14px] leading-[27px] text-[#555555] underline mr-1'>
                            Temu
                        </span>

                        <span className='text-[14px] leading-[27px] text-[#555555]'>
                            ships its products from a global network of suppliers and manufacturers,
                            using experienced and reliable logistics partners. Temu's shipping origins
                            can vary depending on the product being purchased. However, Temu works with
                            leading package carriers like UPS, FedEx, and USPS to ensure that all orders
                            are delivered promptly and securely to customers.
                        </span>
                    </div>

                    <div className="mx-[200px] h-[42px] mt-[36px] text-center text-[#fb7701]">
                        <div className='text-[28px] leading-[42px]  font-[500]'>Temu's unique strengths</div>
                    </div>

                    <div className="mx-[190px] gap-[23px] flex flex-col items-center   text-[#fb7701] mt-[10px]">
                        <div className='text-[14px] leading-[27px] text-[#7d7d7d] mr-1'>
                            Temu is bringing the world’s best sellers, manufacturers and brands of all sizes to your doorstops because of our:
                        </div>

                        <ul className='text-[17px] leading-[27px] text-[#656565]  mr-1'>
                            <li className='my-1'>Ability to <b>source the best products</b> globally</li>
                            <li className='my-1'>Experience in <b>managing complex logistical supply chains</b></li>
                            <li className='my-1'><b>Consumer-to-Manufacturing (“C2M”)</b></li>
                        </ul>
                    </div>

                    <div className="mx-[190px] gap-[47px] flex flex-row items-center text-[#fb7701] mt-[16px]">
                        <Image src={about2} className='h-[302px] w-auto' />
                        <Image src={about3} className='h-[302px] w-auto' />
                        <Image src={about4} className='h-[302px] w-auto' />
                        <Image src={about5} className='h-[302px] w-auto' />
                    </div>

                    <div className="mx-[200px] h-[42px] mt-[77px] text-center text-[#fb7701]">
                        <div className='text-[28px] leading-[42px] font-[500]'>Our values</div>
                    </div>

                    <div className="mx-[190px] gap-[90px] flex flex-row items-center text-[#fb7701] mt-[10px]">
                        <div className='h-[120px] w-[520px] flex flex-row gap-[50px] items-center'>
                            <div>
                                <Image src={about6} className='h-[120px] w-auto' />
                            </div>
                            <div className='flex flex-col gap-[9px]'>
                                <div className='text-[22px] leading-[22px]'>Empowerment</div>
                                <div className='text-[12px] leading-[15px] text-gray-400'>Everyone deserves to live the life they dream of having</div>
                            </div>
                        </div>

                        <div className='h-[120px] w-[520px] flex flex-row gap-[50px] items-center'>
                            <div>
                                <Image src={about7} className='h-[120px] w-auto' />
                            </div>
                            <div className='flex flex-col gap-[9px]'>
                                <div className='text-[22px] leading-[22px]'>Inclusion and diversity</div>
                                <div className='text-[12px] leading-[15px] text-gray-400'>Respect and embrace differences</div>
                            </div>
                        </div>
                    </div>

                    <div className="mx-[190px] gap-[90px] flex flex-row items-center text-[#fb7701]">
                        <div className='h-[120px] w-[520px] flex flex-row gap-[50px] items-center'>
                            <div>
                                <Image src={about8} className='h-[120px] w-auto' />
                            </div>
                            <div className='flex flex-col gap-[9px]'>
                                <div className='text-[22px] leading-[22px]'>Integrity</div>
                                <div className='text-[12px] leading-[15px] text-gray-400'>Honest, ethical and trustworthy</div>
                            </div>
                        </div>

                        <div className='h-[120px] w-[520px] flex flex-row gap-[50px] items-center'>
                            <div>
                                <Image src={about9} className='h-[120px] w-auto' />
                            </div>
                            <div className='flex flex-col gap-[9px]'>
                                <div className='text-[22px] leading-[22px]'>Socially responsible</div>
                                <div className='text-[12px] leading-[15px] text-gray-400'>Do good for the world</div>
                            </div>
                        </div>
                    </div>
